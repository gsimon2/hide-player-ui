...
export class HidePlayerUISettingsForm extends FormApplication {
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            title: game.i18n.localize('hide-player-ui.settings-form.hide-connecting-players-ui.title'),
    ...
    _updateObject(events, formData) {
        let settings = mergeObject(this.storedData, formData, {insertKeys: true, insertValues: true});
